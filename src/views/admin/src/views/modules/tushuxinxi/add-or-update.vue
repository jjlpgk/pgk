    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tushufengmian" label="图书封面" prop="tushufengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tushufengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="分享方式" prop="fenxiangfangshi">
          <el-select :disabled="ro.fenxiangfangshi" v-model="ruleForm.fenxiangfangshi" placeholder="请选择分享方式">
            <el-option
                v-for="(item,index) in fenxiangfangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="分享方式" prop="fenxiangfangshi">
	      <el-input v-model="ruleForm.fenxiangfangshi"
                placeholder="分享方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="图书详情" prop="tushuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tushuxiangqing" label="图书详情" prop="tushuxiangqing">
                    <span v-html="ruleForm.tushuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushufengmian = true;
          ...
          if(o=='fenxiangfangshi'){
            this.ruleForm.fenxiangfangshi = obj[o];
	    this.ro.fenxiangfangshi = true;
            continue;
          }
          if(o=='tushuzuozhe'){
      ...
      this.$http({
		...
		if(json.lianxidianhua!=''&&json.lianxidianhua){
          ...
          this.$message.error(data.msg);
            ...
            this.fenxiangfangshiOptions = "以一换一,免费赠送,其他".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.tushuxiangqing = this.ruleForm.tushuxiangqing.replace(reg,'../../../nodejssh0na/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
